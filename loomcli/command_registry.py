...
COMMANDS: list[dict[str, Any]] = [
    ...
    {
        "command": "weave agent-session bootstrap",
        "category": "coordination",
        "summary": "Bootstrap an empty-folder client into a Powerloom project.",
        "status": "available",
        "args": [],
        "options": [
            "--project",
    ...
    {
        "command": "weave milestone ls",
        "category": "coordination",
        "summary": "List tracker milestones in a project.",
        "status": "available",
        "args": [],
        "options": ["--project", "--status", "--json"],
    },
    {
        "command": "weave milestone create",
        "category": "coordination",
        "summary": "Create a tracker milestone in a project.",
        "status": "available",
        "args": [],
        "options": ["--project", "--title", "--description", "--target-date", "--json"],
    },
    {
        "command": "weave milestone show",
        "category": "coordination",
        "summary": "Show a milestone by UUID, id prefix, or exact title.",
        "status": "available",
        "args": ["milestone_ref"],
        "options": ["--project", "--json"],
    },
    {
        "command": "weave milestone update",
        "category": "coordination",
        "summary": "Update a milestone by UUID, id prefix, or exact title.",
        "status": "available",
        "args": ["milestone_ref"],
        "options": ["--project", "--title", "--description", "--target-date", "--status", "--json"],
    },
    {
        "command": "weave milestone close",
        "category": "coordination",
        "summary": "Mark a milestone closed.",
        "status": "available",
        "args": ["milestone_ref"],
        "options": ["--project", "--json"],
    },
    {
        "command": "weave milestone reopen",
        "category": "coordination",
        "summary": "Mark a milestone open.",
        "status": "available",
        "args": ["milestone_ref"],
        "options": ["--project", "--json"],
    },
    {
        "command": "weave sprint create",
        "category": "coordination",
        "summary": "Create a sprint, optionally nested under a milestone.",
        "status": "available",
        "args": [],
        "options": ["--project", "--name", "--slug", "--description", "--status", "--start-date", "--end-date", "--goal", "--milestone", "--json"],
    },
    {
        "command": "weave sprint list",
        "category": "coordination",
        "summary": "List sprints in a project, optionally filtered by milestone.",
        "status": "available",
        "args": [],
        "options": ["--project", "--status", "--milestone", "--limit", "--json"],
    },
    {
        "command": "weave sprint add-thread",
        "category": "coordination",
        "summary": "Link a thread to a sprint.",
        "status": "available",
        "args": ["sprint_ref", "thread_ref"],
        "options": ["--json"],
    },
    {
