...
COMMANDS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "summary": "Show one coordination session, assigned tasks, and recent events when available.",
        "status": "available",
        "args": ["session_id"],
        "options": ["--events-limit", "--json"],
    },
    {
        "command": "weave agent-session watch",
        "category": "coordination",
        "summary": "Poll one coordination session and its assigned tasks.",
        "status": "available",
        "args": ["session_id"],
        "options": ["--interval", "--events-limit", "--once"],
    },
    {
        ...
        "status": "available",
        "args": [],
        "options": ["--status", "--limit", "--output", "--watch", "--interval", "--once"],
    },
    {
